...
// import * as treeOperations from './../../src/_utils/operations/tree-operations';
//
// let base = {
// 	"0": {
// 		"id": 0,
...
//
// 		expect(
// 			treeOperations._findMaxOrder(state)
// 		).toEqual(3)
// 	});
//
...
//
// 		expect(
// 			treeOperations._findMinOrder(state)
// 		).toEqual(1)
// 	});
//
...
//
// 		expect(
// 			treeOperations._findOrderLowerThan(state, 3)
// 		).toEqual(shortBase[5])
// 	});
//
...
//
// 		expect(
// 			treeOperations._findOrderUpperThan(state, 2)
// 		).toEqual(shortBase[3])
// 	});
//
//
